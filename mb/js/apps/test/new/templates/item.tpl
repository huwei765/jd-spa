            <div class="fixed-top">
                <div class="s-item bdb-1px">
                    <div class="sitem-l sitem-pad">
                        ...
                        <div class="svalue"> <input type="text" class="ad-name" value="" maxlength="25" name="Testess.name" id="uersNameId"></div>
                    </div>
                ...
                <div class="s-item bdb-1px">
                    <div class="sitem-l sitem-pad">
                        ...
                        <div class="svalue" id="mobileInputDiv">  <input type="tel" class="ad-mobile" value="" name="Testess.mobile" maxlength="11" id="mobilePhoneId"></div>
                    </div>
                ...
                <div id="fixed-bottom" class="fixed-bottom" style="width: 100%;">
                                        <div region-data="" id="selectTestessBtn" class="col02">
                        <div class="s-item bdb-1px">
                            <div class="sitem-l sitem-pad add-box">
                                <div class="sattr-add">所在地区:
                                </div>
                                <div class="svalue-add">                                    <span id="TestessLabelId" class="svalue-add"></span>
                                </div>
                            </div>
                    ...
                    <div class="s-item change-padd">
                        <div class="sitem-l sitem-pad change-wid">
                            ...
                            <div class="svalue w65 change-po">
                                ...
                                <textarea rows="1" maxlength="410" id="Testess_where" name="Testess.where" class="textauto change-sty" data-autosize-on="true" style="overflow: hidden; word-wrap: break-word; height: 19px;"></textarea>
                            </div>
                        </div>
